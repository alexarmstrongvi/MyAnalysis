...
python make_stack_plot.py -v 'j_flav' &
python make_stack_plot.py -v 'j_pt[0]' &
python make_stack_plot.py -v 'j_pt[1]' &
python make_stack_plot.py -v 'j_pt[2]' &
python make_stack_plot.py -v 'j_pt[3]' &
